-- -------------------------------------------- --
-- La Vendetta Boss Mods - zhTW localization    --
--          by Destiny|Tandanu                  --
-- -------------------------------------------- --
...
BINDING_NAME_TOGGLE     = "開啟圖形界面";

--OnLoad messages
LVBM_LOADED             = "La Vendetta Boss Mods v%s 由 La Vendetta|Nitram @ EU-Azshara 與 DeadlyMinds|Tandanu @ EU-Aegwynn 製作, 已載入.";
LVBM_MODS_LOADED        = "%s %s boss mods 已載入."

--Slash command messages
LVBM_MOD_ENABLED        = "Boss mod 已啟用.";
LVBM_MOD_DISABLED       = "Boss mod 已禁用.";
LVBM_ANNOUNCE_ENABLED   = "開啟廣播";
LVBM_ANNOUNCE_DISABLED  = "關閉廣播";
LVBM_MOD_STOPPED        = "計時停止";
LVBM_MOD_INFO           = "Boss mod v%s 由 %s";
LVBM_SLASH_HELP1        = " 開啟/關閉";
LVBM_SLASH_HELP2        = " 廣播 開啟/關閉";
LVBM_SLASH_HELP3        = " 停止";
...
LVBM_NEED_LEADER                = "你必須為助理或團長才能對頻道廣播!";
LVBM_NEED_LEADER_STOP_ALL       = "你必須為助理或團長才能使用此功能!";
LVBM_ALL_STOPPED                = "停止所有計時器.";
LVBM_REC_STOP_ALL               = "停止接收來自 %s 的所有命令.";

--Update dialog
LVBM_UPDATE_DIALOG              = "你的 La Vendetta Boss Mod 已經過期!\n%s 和 %s 有版本 %s.\n請參觀 www.curse-gaming.com 以取得最新版本.";
LVBM_YOUR_VERSION_SUCKS         = "你的 La Vendetta Boss Mod 已經過期! 請參觀 www.curse-gaming.com 以取得最新版本.";
LVBM_REQ_PATCHNOTES             = "向 %s 請求改版記錄...請稍待.";
LVBM_SHOW_PATCHNOTES            = "顯示改版記錄";
LVBM_PATCHNOTES                 = "改版記錄";
...
LVBM_DEFAULT_BUSY_MSG           = "%P 正在忙碌. (正在進行戰鬥 %B - %HP - %ALIVE/%RAID 人還活著) 等戰鬥結束之後將回應你.";
LVBM_RAID_STATUS_WHISPER        = "%B - %HP - %ALIVE/%RAID 人還活著.";
LVBM_SEND_STATUS_INFO           = "密語 \"status\" 取得團隊的狀態.";
...
-- Added 11.11.06
LVBM_NOGUI_ERROR				= "抱歉, 請啟用 LVBM GUI 以便存取這個函式";
LVBM_NOSYNCBARS					= "現在沒有任何狀態條";
