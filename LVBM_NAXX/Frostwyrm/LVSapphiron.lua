...
LVBM.AddOns.Sapphiron = {
	...
	["DropdownMenu"] = {
		...
		[2] = {
			["variable"] = "LVBM.AddOns.Sapphiron.Options.ShowPing",
			["text"] = LVBM_SAPPHIRON_PING_INFO,
			["func"] = function()
				LVBM.AddOns.Sapphiron.Options.ShowPing = not LVBM.AddOns.Sapphiron.Options.ShowPing;
				if LVBM.AddOns.Sapphiron.InCombat then
					LVBM.AddOns.Sapphiron.HidePings((not LVBM.AddOns.Sapphiron.Options.ShowPing));
				end
			end,
		},
	},
	...
	["OnCombatEnd"] = function()
		...
		LVBM.AddOns.Sapphiron.HidePings(false);
	end,
	["TargetTime"] = 0,
	["LastTarget"] = "",
	...
	["PingMiniMap"] = function()
		if( (time() - LVBM.AddOns.Sapphiron.PingStartedTime) < 30 ) then	-- Protect Ping Spam !! :)
	...
	["HidePings"] = function(value)
		if value then
			...
			Minimap_SetPing = LVBM.Hooks.oldMinimap_SetPing;
		end
	end,
...
LVBM.Hooks.oldMinimap_SetPing = Minimap_SetPing;