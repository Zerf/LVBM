...
--Gluth
	...
	LVBM_GLUTH_FEAR_REGEXP				= "([^%s]+)受到了恐惧怒吼效果的影响。";
...
--Thaddius
	...
	LVBM_THADDIUS_FIX_LAG          		= "缩短战斗记录侦测距离以尽量避免延迟"
	...
	LVBM_THADDIUS_PLATFORM_EXPR			= "的连接中断了。";
...
--Gothik the Harvester
	...
	LVBM_GOTH_WAVE_INC_WARNING1		= "*** 3秒后第%s/18波 - %s %s  ***";
	LVBM_GOTH_WAVE_INC_WARNING2		= "*** 3秒后第%s/18波 - %s %s 与 %s %s ***";
	LVBM_GOTH_WAVE_INC_WARNING3		= "*** 3秒后第%s/18波 - %s %s, %s %s 与 %s %s ***";
...
-- FourHorsemen
	...
	LVBM_FOURHORSEMEN_VOID_ALLWAYS_INFO			= "虚空领域时显示特殊警报";
...
--Noth the Plaguebringer
	...
	LVBM_NTP_NEXT_WAVE_SOON			= "*** 瘟疫勇士 - 10秒后刷新 ***";
