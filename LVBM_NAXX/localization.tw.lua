...
LVBM_PWSTATS_MAX_HIT            = "最大傷害:  %s on %s";
...
LVBM_GROBB_INJECTION_REGEXP         = "(.+)受到(.*)突變注射";
...
LVBM_GLUTH_FEAR_REGEXP              = "(.+)受到(.*)恐嚇咆哮";
...
LVBM_FOURHORSEMEN_MARK_EXPR                 = "受到(.*)印記";
LVBM_FOURHORSEMEN_MARK_INFOMESSAGE          = "用戶端超出距離無法同步, 重新與其他玩家同步印記 #";
...
LVBM_FOURHORSEMEN_VOID_ALLWAYS_INFO		= "對於虛空地區總是使用特別警告";
...
LVBM_FOURHORSEMEN_TAUNTRESIST_INFO		= "提示嘲諷被抵抗";
LVBM_FOURHORSEMEN_TAUNTRESIST_TAUNT		= "嘲諷";
LVBM_FOURHORSEMEN_TAUNTRESIST_MOKING		= "懲戒痛擊";
LVBM_FOURHORSEMEN_TAUNTRESIST_CSHOUT		= "挑戰怒吼";
LVBM_FOURHORSEMEN_TAUNTRESIST_RESIST		= "抵抗";
LVBM_FOURHORSEMEN_TAUNTRESIST_PARRY		= "招架";
LVBM_FOURHORSEMEN_TAUNTRESIST_DODGE		= "躲閃";
LVBM_FOURHORSEMEN_TAUNTRESIST_MISS		= "未擊中";
LVBM_FOURHORSEMEN_TAUNTRESIST_BLOCK		= "格擋";
LVBM_FOURHORSEMEN_TAUNTRESIST_SELFWARN		= "嘲諷失敗";
LVBM_FOURHORSEMEN_TAUNTRESIST_MESSAGE		= "--> 嘲諷失敗! <--";

--Thaddius
LVBM_THADDIUS_NAME          = "泰迪斯";
LVBM_THADDIUS_DESCRIPTION   = "提供激怒和兩極移形計時.";
LVBM_THADDIUS_WARN_NOT_CHANGED      = "極性未改變時提示";
LVBM_THADDIUS_ALT_STRATEGY      = "二選一戰略 (顯示 左/右 警告)";
LVBM_THADDIUS_WARN_POWERSURGE       = "斯塔拉格的力量澎湃警告 (200% 攻擊速度)";
LVBM_THADDIUS_FIX_LAG           = "減少戰鬥紀錄距離以預防延遲"
...
LVBM_THADDIUS_TESLA_EMOTE       = "%s 過載了";
...
LVBM_LOATHEB_DESCRIPTION        = "洛斯伯無可避免的末日警告, 以及顯示治療冷卻時間. 使用 /loatheb setup 或 /loatheb config 設定治療鏈. 如果沒有設定治療鏈, 治療者警告將不會作用。 把某個治療者的排序號碼設定為 0 將把他移出治療鏈. 要把他重新加回來, 輸入 /loa undelete.";
LVBM_LOATHEB_ANNOUNCE_SPORES        = "孢子廣告"
--LVBM_LOATHEB_ANNOUNCE_SPORES_BACKWARDS        = "警告孢子出現在隊伍後方";
...
LVBM_LOATHEB_NO_BC_INFO             = "你不是領隊或是助手. 你做的改變將無法同步設定整個團隊, 同時, 隊伍宣佈的設定將覆蓋你的.";
LVBM_LOATHEB_NO_CD                  = "無CD";
LVBM_LOATHEB_SET_HEAL_ROTATION      = "儲存與同步";
LVBM_LOATHEB_SET_HEAL_ROTATION_NO_BC        = "儲存";
...
LVBM_SAPPHIRON_YELL_INFO        = "受到寒冰屏障影響時喊叫";
LVBM_SAPPHIRON_YELL_ANNOUNCE        = "我變成寒冰屏障了, 站到我後面去!";

LVBM_SAPPHIRON_LIFEDRAIN_EXPR1      = "受到了吸取生命效果的影響。";
LVBM_SAPPHIRON_LIFEDRAIN_EXPR2      = "的吸取生命被.*抵抗了。";
...
LVBM_SAPPHIRON_FROSTBOLT_GAIN_EXPR  = "你受到了寒冰箭效果的影響";
LVBM_SAPPHIRON_FROSTBOLT_FADE_EXPR  = "寒冰箭效果從你身上消失了";
...
LVBM_KELTHUZAD_RANGECHECK       = "在第二及第三階段顯示距離框";
...
LVBM_KELTHUZAD_DETONATE_EXPR        = "^(.+)受到(.*)爆裂法力";
