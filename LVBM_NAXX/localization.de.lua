if GetLocale() == "deDE" then
	...
	LVBM_SAPPHIRON_PING_INFO		= "Minimap Pings anzeigen";
	...
	LVBM_FOURHORSEMEN_MOGRAINE			= "Hochlord Mograine";
	LVBM_FOURHORSEMEN_ZELIEK			= "Sire Zeliek";

	LVBM_FOURHORSEMEN_REAL_NAME			= "Four Horsemen";
	
	LVBM_FOURHORSEMEN_WHISPER_INFO			= "Spielern in Void Zonen whispern";
	LVBM_FOURHORSEMEN_SYNC_INFO			= "Mark mit anderen Clients synchronisieren";
	LVBM_FOURHORSEMEN_INFOFRAME_INFO		= "InfoFrame mit Boss HP während dem Kampf anzeigen";
