...
if GetLocale() == "deDE" then
	...
	LVBM_TWINEMPS_DESCRIPTION	= "Stellt Timer f\195\188r die Zwillings Imperatoren zur Verf\195\188gung. Die KÃ¤fer Explosions Warnung sollte mit hoher Combat Log Reichweite nicht verwendet werden."
	LVBM_TWINEMPS_BUG_EXPLOE	= "Warnung anzeigen, wenn ein KÃ¤fer explodiert";
