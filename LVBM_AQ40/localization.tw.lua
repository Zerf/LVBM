...
LVBM_THREEBUGS_FEAR_EXPR            = "(.+)受到(.*)恐懼術";
LVBM_THREEBUGS_FEAR_ANNOUNCE        = "*** 亞爾基的恐懼即將在 %d 秒後到來 ***";
LVBM_THREEBUGS_CASTHEAL_EXPR        = "亞爾基公主開始施放強效治療術。";
LVBM_THREEBUGS_CASTHEAL_ANNOUNCE    = "*** 亞爾基公主正在施放強效治療術, 快中斷 ***";
...
LVBM_HUHURAN_WYVERN_REGEXP      = "(.+)受到(.*)翼龍釘刺";
LVBM_HUHURAN_FRENZY             = "%s變得狂暴起來！";
...
LVBM_DEFENDER_PLAGUE_REGEXP     = "^(.+)受到(.*)瘟疫";
...
LVBM_OURO_ENRAGE                = "%s進入狂暴狀態！";
LVBM_OURO_ENRAGE_ANNOUNCE		= "*** 狂暴 ***";
LVBM_OURO_OURO                  = "奧羅";
