...
-- LVOnyxia
	...
	LVBM_ONYXIA_PHASE2_YELL			= "这毫无意义的行动让我很厌烦。我会从上空把你们都烧成灰！";
	LVBM_ONYXIA_PHASE2_ANNOUNCE		= "*** 第二阶段 ***"
	LVBM_ONYXIA_PHASE3_YELL			= "看起来需要再给你一次教训，凡人！";
...
-- LVBattleGrounds
	...
	LVBM_BGMOD_LANG["AB_CLAIMSTHE"]			= "([^%s]+)攻占了([^%s]+)！如果不赶快采取行动的话，([^%s]+)在1分钟内([^%s]+)它！";
	LVBM_BGMOD_LANG["AB_HASTAKENTHE"]		= "([^%s]+)夺取了([^%s]+)！";
	LVBM_BGMOD_LANG["AB_HASDEFENDEDTHE"]	= "([^%s]+)守住了([^%s]+)！";
	LVBM_BGMOD_LANG["AB_HASASSAULTED"]		= "突袭了";
	...
	LVBM_BGMOD_LANG["WSG_ALLYFLAG"]			= "联盟: ";
...
--Runecloth
	...
	LVBM_RUNECLOTH_DESCRIPTION  = "自动上交符文布";
	LVBM_RAEDONDUSKSTRIKER      = "莱顿·暗影";
	LVBM_CLAVICUSKNAVINGHAM     = "克拉维斯·纳文哈姆";
	LVBM_BUBULOACERBUS          = "巴巴罗·阿克巴斯";
	LVBM_MISTINASTEELSHIELD     = "米斯蒂娜·钢盾";
	LVBM_RUNECLOTH_THANKS       = "感谢您使用 La Vendetta BossMods！";
