...
LVBM_ONYXIA_BREATH_EMOTE    = "%s深深地吸了一口氣...";
LVBM_ONYXIA_BREATH_ANNOUNCE = "*** 奧妮克希亞深呼吸即將出現，向邊緣散開！ ***";
LVBM_ONYXIA_PHASE2_YELL     = "這毫無意義的行動讓我很厭煩。我會從上空把你們都燒成灰！";
LVBM_ONYXIA_PHASE2_ANNOUNCE = "*** 奧妮克希亞進入第二階段 ***";
LVBM_ONYXIA_PHASE3_YELL     = "看起來需要再給你一次教訓，凡人！";
...
LVBM_AZUREGOS_SHIELDUP_EXPR         = "艾索雷葛斯獲得了反射的效果。";
...
LVBM_BGMOD_LANG["AV_UNDERATTACK"]	= "(.+)受到攻擊！如果不採取措施的話，(.+)將會(.+)這片土地！";	-- Graveyard // Tower
LVBM_BGMOD_LANG["AV_WASTAKENBY"]	= "(.+)被(.+)佔領了！";
LVBM_BGMOD_LANG["AV_WASDESTROYED"]	= "(.+)被(.+)摧毀了！";
...
LVBM_BGMOD_LANG["AB_CLAIMSTHE"]	    = "(.+)突襲了(.+)！如果沒有其他人採取行動的話，(.+)將在一分鐘內控制它！";
LVBM_BGMOD_LANG["AB_HASTAKENTHE"]	= "(.+)奪取了(.+)！";
LVBM_BGMOD_LANG["AB_HASDEFENDEDTHE"] = "(.+)守住了(.+)！";
LVBM_BGMOD_LANG["AB_HASASSAULTED"]	= "攻佔了";
LVBM_BGMOD_LANG["AB_SCOREEXP"] 		= "基地：(%d+) 資源：(%d+)/2000";
LVBM_BGMOD_LANG["AB_WINALLY"] 		= "聯盟勝利還需";
LVBM_BGMOD_LANG["AB_WINHORDE"] 		= "部落勝利還需";
...
LVBM_BGMOD_LANG["WSG_FLAG_PICKUP"] 	= "(.+)的旗幟被(.+)拔掉了！";			-- . because the F is not allways large char 
LVBM_BGMOD_LANG["WSG_FLAG_RETURN"]	= "(.+)的旗幟被(.+)還到了它的基地";
LVBM_BGMOD_LANG["WSG_ALLYFLAG"]		= "聯盟: ";
LVBM_BGMOD_LANG["WSG_HORDEFLAG"]	= "部落: ";
LVBM_BGMOD_LANG["WSG_FLAG_BASE"]	= "基地";
LVBM_BGMOD_LANG["WSG_HASCAPTURED"]	= "(.+)佔據了(.+)的旗幟！";
...
LVBM_BGMOD_LANG["WSG_BOOTS_EXPR"]	= "受到(.*)加速";
...
LVBM_SBT["Speed Boots"] = "加速鞋";
LVBM_SBT["Flag respawn"] = "旗幟重生";
LVBM_SBT["Ivus spawn"] = "伊弗斯出生";
LVBM_SBT["Ice spawn"] = "冰雪出生";
...
LVBM_OUTDOOR_NOX_BREATH     = "([^%s]+)受到(.*)毒性吐息";
LVBM_OUTDOOR_NOX_RESIST     = "([^%s]+)的毒性吐息被([^%s]+)抵抗了。" ;
LVBM_OUTDOOR_INFECTION      = "([^%s]+)受到(.*)快速傳染";
