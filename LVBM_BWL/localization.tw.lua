...
LVBM_CHROMAGGUS_VULNERABILITY_REGEXP    = ".+的.+克洛瑪古斯(.*)造成(%d+)點(.+)傷害。";
...
LVBM_NEFARIAN_SYNCKILLS_INFO	= "在第一階段同步並廣播龍獸擊殺數";
LVBM_NEFARIAN_SYNCKILLS_ANNOUNCE	= "*** %d 隻龍獸已倒地 ***";
...
LVBM_NEFARIAN_DRUID_WARNING     = "*** 德魯伊 - 強制貓形態 ***";
LVBM_NEFARIAN_PRIEST_WARNING        = "*** 牧師 - 停止治療! ***";
LVBM_NEFARIAN_WARRIOR_WARNING       = "*** 戰士 - 強制狂暴姿態 ***";
...
LVBM_NEFARIAN_KILLCOUNT			= "目前擊殺: %d";
