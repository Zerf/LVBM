...
--Nefarian
	...
	LVBM_NEFARIAN_SYNCKILLS_ANNOUNCE	= "*** 已击杀%d只龙兽 ***";
	...
	LVBM_NEFARIAN_YELL_SHAMANS			= "萨满祭司，让我看看你们的图腾到底是干什么用的！";
	LVBM_NEFARIAN_YELL_PALAS			= "圣骑士……听说你们有无数条命。让我看看到底是怎么样的吧。";
	LVBM_NEFARIAN_YELL_DRUIDS			= "德鲁伊和你们愚蠢的变形法术。让我们看看有什么事情会发生吧！";
