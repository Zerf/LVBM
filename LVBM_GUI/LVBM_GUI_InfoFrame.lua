...
function LVBM_Gui_DistanceFrame(moption) --fix me
...
function LVBM_Gui_DistanceFrame_Show()
	if( LVBMDistanceFrame ) then
		LVBMDistanceFrame:Show();
	else
		LVBM_Gui_CreateDistanceFrame();
	end
end

function LVBM_Gui_DistanceFrame_Hide()
	if( LVBMDistanceFrame ) then
		LVBMDistanceFrame:Hide();
	end
end
