...
LVBMGUI_DROPDOWNMENU_TITLE      = "Boss Mod 選單";
...
LVBMGUI_BUTTON_SPECWARNING_EXAMPLE      = "測試訊息 囧";
...
LVBMGUI_DROPDOWN_STATUSBAR_DESIGN_1     = "傳統設計"; --wird erfl sig mit dem Verwenden des Namens aus der Tabelle
...
LVBMGUI_TAB_OTHER_TEXT              = "其它";
LVBMGUI_BUTTON_LOADADDON            = "載入插件";
...
-- Range stuff
LVBM_GUI_COMBATLOG_RANGE_TITLE      = "戰鬥紀錄距離";
LVBM_GUI_COMBATLOG_MIN_RANGE        = "戰鬥紀錄距離設定為最短距離";
LVBM_GUI_COMBATLOG_MAX_RANGE        = "戰鬥紀錄距離設定為最大距離";
LVBM_GUI_COMBATLOG_LONG_RANGE       = "戰鬥紀錄距離設定為長距離";
LVBM_GUI_COMBATLOG_DEFAULT_RANGE    = "戰鬥紀錄距離設定為預設距離";
