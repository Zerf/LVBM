...
LVBM_MOAM_COMBAT_START          = "%s因神態失常而坐立不安。";
LVBM_MOAM_STONE_ANNOUNCE_TIME   = "*** %s 秒後進入石化狀態 ***";
LVBM_MOAM_STONE_GAIN            = "%s吸取你的法力後變成了石頭。";
LVBM_MOAM_STONE_ANNOUNCE_FADE   = "*** %s 秒後石化狀態結束 ***";
...
LVBM_BURU_EYE_ANNOUNCE          = "*** %s 被布魯盯上了! 注意治療! ***";
...
LVBM_AYAMISS_SACRIFICE_ANNOUNCE = "*** %s 變成祭品了, 快殺札拉幼蟲! ***";
